        ...
        <TransitionSlideUp>
          <div className="max-w-4xl w-full mx-auto">
            ...
            <p className="text-gray-700 text-base md:text-lg mb-6 text-justify">
              At Neil Bran Hacks, we understand the importance of keeping your cryptocurrency safe and secure. That's why we're dedicated to recovering scammed assets and the passwords to your forgotten wallets, ensuring that your digital assets remain in your possession.
            </p>
            <p className="text-gray-700 text-base md:text-lg mb-6 text-justify">
            ...
            <p className="text-gray-700 text-base md:text-lg mb-6 text-justify">
              NeilBran Hacks was created to empower cryptocurrency owners to keep their assets safe. The company was founded in 2017 by Niel Bran, a seasoned professional with a background in technology and a wealth of experience in the industry. He was previously the VP of Technology at Carescout and a programmer at Fidelity Investments.
            </p>
            <p className="text-gray-700 text-base md:text-lg mb-10 text-justify">
